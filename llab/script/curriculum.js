...
llab.createTitleNav = function() {
     ...
     var topHTML = (
          ...
          buttons = "<a class='btn btn-default backbutton arrow'>←</a>" +
                       "<a class='btn btn-default forwardbutton arrow'>→</a>";
